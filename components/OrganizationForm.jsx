  ...
  return (
    <div className="mx-auto w-full max-w-5xl">
      <PageHeader
        ...
        description={
          isSetup
            ? (<label>This setup is required before the system workspace is available. The company profile is needed to access the services of Primary.  You are automatically the <strong>System Admin</strong> of the account of your company in Primary.</label>)
